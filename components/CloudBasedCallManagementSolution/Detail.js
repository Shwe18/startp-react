...
const Detail = () => {
    return (
        <div className="agency-services-area ptb-70 py-2">
            <div className="container">
                <div className="row align-items-center">
                <div className="container fluid">
                <div className="content">
                <h3 className="text-center">Cloud based Call Management Solution will helps you to manage Communication with Customers</h3>
