        ...
        <>
            <div className="services-area bg-f7fafd">
                ...
                <div className="row">      
                    ...
                    <br />
                    <h4 className="text-center"><strong>Make your operations more transparent & increase your business…</strong></h4>
                    ...
                    <br />
                    <h6 className="text-center"><strong>Introducing BeTyphon – The best Lead Management Solution for Your Business Growth</strong></h6>
                    ...
                    <h6><strong>BeTyphon is easy to use, flexible to suit your specific needs –</strong></h6>
                        <ul>
                        ...
                        * Betyphon mobile app allows the call recording, auto dialing, GPS tracking, Picture upload & much more
                        </ul>
