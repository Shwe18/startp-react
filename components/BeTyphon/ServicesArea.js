                    ...
                    <div className="row justify-content-center align-items-center">
                        <div className="col-lg-6 col-md-12 services-content">
                            ...
                            <div className="row">
                                ...
                                <div className="col-lg-6 col-md-6">
                                    <div className="box">
                                        <Icon.Globe /> Call Recording
                                    </div>
                                </div>

                                <div className="col-lg-6 col-md-6">
                                    <div className="box">
                                        <Icon.File /> Lead Capture
                                    </div>
                                </div>

                                <div className="col-lg-6 col-md-6">
                                    <div className="box">
                                        <Icon.TrendingUp /> Work Anywhere
                                    </div>
                                </div>

                                <div className="col-lg-6 col-md-6">
                                    <div className="box">
                                        <Icon.Folder /> Powerful Forms
                                    </div>
                                </div>

                                <div className="col-lg-6 col-md-6">
                                    <div className="box">
                                        <Icon.Monitor /> Integration 
                                    </div>
                                </div>
            ...
            <div className="services-area ptb-80">
                <div className="container">
                    <div className="row h-100 justify-content-center align-items-center">
                        ...
                        <div className="col-lg-6 col-md-12 services-content">
                            <h3 className="text-center"><strong>BeTyphon helps you to</strong></h3><br />
                            <h5>Are you looking for a software which makes your operations more transparent and add value in your business?</h5>
                            <p><strong>Automate your Operations : </strong>With our smart tools, automate your operations in no time and make room to focus on strategy. Organize, channel and optimize your workflows for maximum efficiency.</p>
                            <p><strong>Create Business Rules : </strong>Build your own business rule which supposed to be followed by each person – Powerful Form, Disposition based on customer discussion, Campaign for Data Sources, Prospect detailed entries, Communcation SMS/Email template based on dispistions,</p>
                            <p><strong>Lead Distribution : </strong>Distribute your lead as per current requirement of business line – Pool allocation, Sepcific Allocation & Rule based. Create auto rule engine as per requirement.</p>
                            ...
                            <p><strong>Customer Management : </strong> Manage your customers on Cloud – no intranet or server required. With cloud based Web Software / Mobile Application, Upload the data in software Or integrate the lead sources with Betyphon. Enjoy the ease of a paperless office.</p>
                            <p><strong>Enhance Team Performance : </strong>On basis of reports (Call Recording, Disposition histories of dial-out, Login hours, Complete detailed report)  you can actually execute your team to make better performance. </p>
                            <p><strong>Work and track from anywhere : </strong>Your employees can work from anywhere and you can track their progress </p>
                            <p><strong>Scalable tool : </strong>Betyphon is a tool which can be accessed by multiple counts with hierarchy which makes business more efficient and scalable.</p>
                            <br />
                        </div>
                    </div>
