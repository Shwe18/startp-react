            ...
            <div className="services-area ptb-80">
                <div className="container">
                    <div className="row h-100 justify-content-center align-items-center">
                        ...
                        <div className="col-lg-6 col-md-12 services-content">
                            <h5><strong>How actually IVR Solution works</strong></h5>
                            <p>Anyone who calls on your Office Number (Virtual Number), will first hear a Company welcome message (<strong>Welcome to XYZ Company Limited, We offers the special products and services</strong> post welcome message IVR extension option will come :</p>
